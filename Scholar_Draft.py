...
def scholar():
        CW = [0,1,2,3,4,5,6]				# Continue Working dialog list
        TB = [0,1,2,3]						# Take Break dialog list
                ...
                if answer == '2':
                        ...
                        if answer == '2':
                                ...
                                if answer == '2':
                                        ...
                                        work()
                                        if answer == '2':
                                                print('In the kitchens, the young brothers drink')						#These lines are a repeat from earlier
                                                print('XXXXX                           and laugh')
                                                print('XXXXX                           as if they will live forever.')
                                                print()
                                                print('Your spirit is renewed, but you lose precious time.')
                                                ...
                                                cont_work()
                                                print('You spend many days in the Library.')
                                                print('transcribing the work of the Ancient Geographers.')				# This looks like end of sequence
                                                print('         You learn much')
